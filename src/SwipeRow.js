...
class SwipeRow extends Component {
  ...
  /*
	 * This method is called by List containing these rows
	 */
  closeRow() {
...
SwipeRow.propTypes = {
  /**
   * Used by the List containing these rows to close rows on scroll events.
  ...
  /**
   * Called when a swipe row is animating open. Used by the List containing these rows
